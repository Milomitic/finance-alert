...
**Le Tranche 1, 2 e 3 sono chiuse.** Restano la Tranche 4 (le connessioni fra
oggetti: FA-029 posizione-segnale, il Divario nello screener, il calendario
dentro i setup, la sorgente degradata dove il dato si consuma) e la Tranche 5.
...
Le otto voci qui sotto sono quello che resta: due in attesa di dati, due in
attesa di un collaudo su dispositivo reale, tre aperte, una che aspetta una
decisione.
