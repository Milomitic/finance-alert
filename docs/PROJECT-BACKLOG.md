...
Le **dieci** voci qui sotto sono quello che resta, e solo quattro sono lavoro:
due in attesa di dati (FA-006, FA-007), due in attesa di un collaudo su
dispositivo reale (FA-011, FA-013), una che aspetta una decisione (FA-026), una
bloccata da fuori (FA-015), e quattro da fare (FA-008, FA-028, FA-034, FA-039).
