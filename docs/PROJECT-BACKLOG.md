...
| FA-008 | P2 | Frontend | Ridurre e presidiare i finding ESLint React Hooks | **OPEN** | Un finding reale di immutabilita corretto in `SignalSnapshotView`; baseline scesa a 56 finding (39 errori, 17 warning) dopo la rimozione di cinque Date.now() dal render. Il gate dedicato `lint:hooks` resta verde; rimangono soprattutto regole v7 da risolvere per tranche. |
...
- I commit locali non ancora sincronizzati su `origin/cloud` includono `cae2986`, `d5d32de`, `3697899`, `af4ec64`, `4ea9447`, `e2a3c88`, `79e30ff`, `c5d3e8b`, `832c7dd`, `73e6d5d`, `333cfff`, `658c8aa` e `2a5ffb9`; la produzione contiene solo il fix metrics `cb524d5`.
