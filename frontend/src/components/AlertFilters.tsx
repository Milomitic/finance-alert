        ...
        <SectionTitle
          ...
          right={
            <div className="flex items-center gap-2">
              ...
              {activeCount > 0 && (
                <span className="inline-flex items-center justify-center min-w-[1.25rem] h-5 px-1.5 rounded-full bg-primary text-primary-foreground text-[0.7059rem] font-bold tabular-nums">
                  {activeCount}
                </span>
              )}
              {activeCount > 0 && (
