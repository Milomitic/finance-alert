...
function Field({
  ...
  return (
    <label className="flex flex-col gap-1 min-w-0">
      <span className="text-[0.6765rem] uppercase tracking-wider text-muted-foreground font-semibold">
        {label}
      </span>
      <Input
        value={value}
...
export function TrackTradeForm({ ticker, alertId, playbook }: Props) {
  ...
  return (
    <div className="mt-2 rounded-md border border-border/60 p-3 space-y-2">
      <div className="text-[0.7059rem] uppercase tracking-wider text-muted-foreground font-semibold">
