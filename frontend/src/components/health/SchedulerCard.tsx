          ...
          return (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="text-[0.7059rem] text-muted-foreground font-mono truncate mt-0.5" title={j.trigger ?? undefined}>
                ...
                {j.next_run_time != null && !late && (
                  <div className="text-[0.7059rem] text-muted-foreground mt-0.5 flex items-center gap-1">
                    <CalendarClock className="h-3 w-3 shrink-0" />
                    prossimo: {nextRunLabel(j.next_run_time)}
                  </div>
                )}
                {j.next_run_time == null && j.trigger == null && (
                  <div className="text-[0.7059rem] text-muted-foreground italic mt-0.5">
                    non più registrato (storico)
                  </div>
                )}
                {j.last_error && (
                  <div className="text-[0.7059rem] text-red-700/80 dark:text-red-400/80 mt-0.5 truncate" title={j.last_error}>
                    ✗ {j.last_error}
                  </div>
                )}
              </div>
