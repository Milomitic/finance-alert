  ...
  return (
    <div className="relative rounded-lg border border-border/60 bg-card overflow-hidden py-2 px-3">
      <div className="flex items-center gap-2 flex-wrap">
        ...
        {event.release_time && (
          <span
            className="inline-flex items-center gap-0.5 text-[0.7059rem] tabular-nums text-muted-foreground shrink-0"
        ...
        <span className="text-[0.7059rem] uppercase tracking-wider text-muted-foreground shrink-0">
        ...
        <span
          className={cn(
            "inline-flex items-center gap-1 rounded-full border px-1.5 py-0.5 text-[0.6765rem] uppercase tracking-wider font-semibold shrink-0",
            importanceChipTone,
          )}
        >
          <ImportanceDots
      ...
      {history.length >= 2 && (
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <button
            ...
            className="text-[0.6765rem] uppercase tracking-wider text-muted-foreground hover:text-foreground transition-colors inline-flex items-center gap-0.5"
          ...
          {event.series_id != null && (
            <Link
              ...
              className="ml-auto inline-flex items-center gap-1 text-[0.7059rem] font-medium text-primary hover:underline"
...
function ExtendedHistoryChart({
  ...
  return (
    <div className="rounded border border-current/15 bg-current/5 p-2">
      <div className="flex items-baseline justify-between text-[0.6765rem] opacity-70 tabular-nums mb-1">
      ...
      <div className="text-[0.6765rem] opacity-70 mt-1 text-right tabular-nums">
        Ultimo:{" "}
      ...
      <div className="mt-2 pt-2 border-t border-current/15 overflow-x-auto">
        <table className="w-full text-[0.7059rem] tabular-nums">
          <thead>
            <tr className="text-[0.6765rem] uppercase tracking-wider opacity-60">
