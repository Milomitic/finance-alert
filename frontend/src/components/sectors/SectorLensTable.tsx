          ...
          <table className="w-full text-sm min-w-[760px]">
            <thead>
              <tr className="border-b">
                {COLUMNS.map((c) => {
                  ...
                  return (
                    <th
                      ...
                      scope="col"
                      className={cn(
                        "px-3 py-1.5 font-medium text-[10px] uppercase tracking-[0.14em]",
                ...
                <th scope="col" className="px-3 py-1.5 text-left font-medium text-[10px] uppercase tracking-[0.14em] text-muted-foreground">
                  Trend
                </th>
              </tr>
            </thead>
                ...
                return (
                  ...
                  >
                    <td className="px-3 py-1.5">
                      ...
                      {s.etf_proxy && (
                        <span className="ml-2 rounded border px-1 text-[10px] text-muted-foreground align-middle">
                          {s.etf_proxy}
                        </span>
                      )}
                    </td>
