      ...
      <DialogContent className="sm:max-w-4xl p-0 max-h-[90vh] overflow-y-auto">
        ...
        >
          <div className="flex items-start justify-between gap-3">
            ...
            <div className="text-right shrink-0 pr-6">
              <div
                className={cn(
                  "flex items-center justify-end gap-1 text-[0.7059rem] font-semibold",
              ...
              {amendedAt && (
                <div
                  className="mt-1 inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-[0.6765rem] font-semibold bg-amber-50 dark:bg-amber-950/40 text-amber-700 dark:text-amber-300 border border-amber-200 dark:border-amber-800/60"
        ...
        <div className="px-5 grid grid-cols-3 gap-3">
          ...
          >
            <div
              className={cn(
                "flex items-center gap-1 text-[0.7059rem] uppercase tracking-wider font-semibold",
