      ...
      <CardContent className="p-3 flex flex-col h-full gap-2">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <div className={cn("text-2xl font-bold leading-none", cfg.fg)}>{cfg.label}</div>
            <div className={cn("text-[10px] mt-1 opacity-80", cfg.fg)}>
          ...
          <div className="text-right tabular-nums shrink-0">
            <div className={cn("text-xl font-bold leading-none", cfg.fg)}>{global.stocks_total}</div>
            <div className={cn("text-[9px] uppercase tracking-wide opacity-60 mt-0.5", cfg.fg)}>stocks</div>
          </div>
        </div>
