...
function SetupLine({ setup }: { setup: Setup }) {
  ...
  return (
    <li>
      <Link
        ...
        className="grid grid-cols-[minmax(0,1fr)_auto] sm:grid-cols-[minmax(0,1fr)_140px_92px_76px] items-center gap-x-3 gap-y-1 px-3 py-1 hover:bg-accent/30 transition-colors"
      >
...
export function SetupConditionGroup({ group }: { group: ConditionGroup }) {
